...
public abstract class AbstractIntegrationTest {
    ...
    static void dynamicProperties(DynamicPropertyRegistry registry) {
        ...
        registry.add("polaris.max-timeout", () -> 1000000000);           // so big it does not get called
        registry.add("polaris.republish.timeout-ms", () -> 1000000000);  // so big it does not get called
