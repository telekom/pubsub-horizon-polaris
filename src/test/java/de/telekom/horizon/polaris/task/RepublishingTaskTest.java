...
class RepublishingTaskTest {
    ...
    void shouldQueryDbPickStatesAndRepublishMessages() {
        when(MockGenerator.messageStateMongoRepo.findByStatusWaitingOrFailedWithCallbackExceptionAndSubscriptionIdsAndTimestampLessThanEqual(anyList(), eq(fakeMessageStatesSubscriptionIds), any(), any()))
